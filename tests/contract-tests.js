...
describe('Contract', function () {
    ...
    */
    ...
    describe('Instantiation', function () {
        ...
        it('Should instantiate a contract with default executor', async () => {


        });

        it('Should have all abi methods', async () => {
        });
    });


    describe('Contract [abi] methods', function () {
        it('Should apply default executor if none or invalid(not an Account instance) is provided', async () => {
        });

        it('Should be able to execute contract method from different executors', async () => {
